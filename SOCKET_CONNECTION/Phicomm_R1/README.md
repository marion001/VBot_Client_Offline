...
- WebUI local tại `http://<ip-loa>:8001`.
...
- `none`: không detect wakeword, chỉ thao tác thủ công.
...
- Version JSON: `Version.GITHUB_API_VERSION_URL`
- APK URL: `Version.REMOTE_APK_URL`

So sánh:

- `remote build_date` khác `Version.CLIENT_VERSION` => có bản mới.
...
- JDK 17
- Android SDK/Build-tools phù hợp
...
## 8. File cấu hình/version quan trọng

- `app/src/main/java/com/vbot/phicommr1/Config.java`
- `app/src/main/java/com/vbot/phicommr1/Version.java`
- `app/src/main/java/com/vbot/phicommr1/MiniWebUiServer.java`
- `app/src/main/java/com/vbot/phicommr1/VBotClientService.java`
- `app/src/main/java/com/vbot/phicommr1/SnowboyClientWakeDetector.java`
