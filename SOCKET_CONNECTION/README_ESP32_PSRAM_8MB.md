# ESP32 PSRAM, flash 8 MB

- Environment: `esp32-psram-8mb`
- Flash: 8 MB
- PSRAM: có
...
```powershell
pio run -e esp32-psram-8mb
pio run -e esp32-psram-8mb -t buildfs
pio run -e esp32-psram-8mb -t upload --upload-port COM11
pio run -e esp32-psram-8mb -t uploadfs --upload-port COM11
```
